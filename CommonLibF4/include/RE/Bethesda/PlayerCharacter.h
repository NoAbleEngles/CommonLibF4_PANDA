...
namespace RE
{
	...
	public:
		...
		void SetAIControlled(bool a_aiControlled)
		{
			using func_t = decltype(&PlayerCharacter::SetAIControlled);
			REL::Relocation<func_t> func{ REL::ID(1431972) };
			return func(this, a_aiControlled);
		}

		void UpdatePlayer3D()
		{
			using func_t = decltype(&PlayerCharacter::UpdatePlayer3D);
			REL::Relocation<func_t> func{ REL::ID(894747) };
			return func(this);
		}

		void CheckForQuestTargetUpdate(RE::TESObjectREFR* a_target) {
			using func_t = decltype(&PlayerCharacter::CheckForQuestTargetUpdate);
			REL::Relocation<func_t> func{ REL::Offset(0xEA4B10) };
